...
pfd_xdmf.CellArrayStatus = ['hx', 'hy', 'hz', 'ex', 'ey', 'ez','vx_i','vy_i','vz_i']
...
RenameSource('Vimag', calculator1)
# Properties modified on calculator1
calculator1.AttributeType = 'Cell Data'
calculator1.ResultArrayName = 'Vimag'
calculator1.Function = 'sqrt(vx_i*vx_i +vy_i*vy_i +vz_i*vz_i)'
# show data in view
...
calculator1_1.Function = 'sqrt(ex*hx +ey*hy +ez*hz)/sqrt(hx*hx + hy*hy + hz*hz)'
# show data in view
...
# set scalar coloring
ColorBy(calculator1Display, ('CELLS', 'Vimag'))
# rescale color and/or opacity maps used to include current data range
calculator1Display.RescaleTransferFunctionToDataRange(True, False)
# show color bar/color legend
calculator1Display.SetScalarBarVisibility(renderView1, True)
# get color transfer function/color map for 'Vimag'
vimagLUT = GetColorTransferFunction('Vimag')
...
vimagLUT.ApplyPreset('Cold and Hot', True)
# Rescale transfer function
vimagLUT.RescaleTransferFunction(-0.017, 0.017)
# get opacity transfer function/opacity map for 'Vimag'
vimagPWF = GetOpacityTransferFunction('Vimag')
# Rescale transfer function
vimagPWF.RescaleTransferFunction(-0.017, 0.017)
...
# save screenshot
SaveScreenshot('/disk/plasmaz/jaa/Critical_Balance/CB8waves_104_1/Video_maglines/Vimag_Epar3_mzmy_5.png', renderView1, ImageResolution=[1550, 803]) #HERE SAVE THE PIC
...
# save screenshot
SaveScreenshot('/disk/plasmaz/jaa/Critical_Balance/CB8waves_104_1/Video_maglines/Vimag_Epar3_mzmx_5.png', renderView1, ImageResolution=[1550, 803]) #HERE SAVE THE PIC
...
# save screenshot
SaveScreenshot('/disk/plasmaz/jaa/Critical_Balance/CB8waves_104_1/Video_maglines/Vimag_Epar3_mxmy_5.png', renderView1, ImageResolution=[1550, 803]) #HERE SAVE THE PIC
