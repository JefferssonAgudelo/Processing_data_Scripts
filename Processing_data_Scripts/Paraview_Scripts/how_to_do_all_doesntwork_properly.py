...
for i in glob.glob( os.path.join(path, '*.xdmf')):
  ...
  pfd_xdmf.CellArrayStatus = ['hx', 'hy', 'hz']
  ...
  # save screenshot
  SaveScreenshot('/disk/plasmaz/jaa/Critical_Balance/Temperature_test/This_are_the_runs_2/one/'+ name1 +'.png', renderView1, ImageResolution=[1550, 803]) #HERE SAVE THE PIC
  # reset view to fit data
  renderView1.ResetCamera()
  ...
  # save screenshot
  SaveScreenshot('/disk/plasmaz/jaa/Critical_Balance/Temperature_test/This_are_the_runs_2/one/'+ name2 +'.png', renderView1, ImageResolution=[1550, 803]) #HERE SAVE THE PIC
  # reset view to fit data
  renderView1.ResetCamera()
  ...
  SaveScreenshot('/disk/plasmaz/jaa/Critical_Balance/Temperature_test/This_are_the_runs_2/one/'+ name3 +'.png', renderView1, ImageResolution=[1550, 803]) #HERE SAVE THE PIC
  ...
  # find source
  bmag = FindSource('Bmag')
  # set active source
  SetActiveSource(bmag)
  # destroy bmag
  Delete(bmag)
  del bmag
  ...
  # find source
  jmag = FindSource('Jmag')
  # set active source
  SetActiveSource(jmag)
  # destroy bmag
  Delete(jmag)
  del jmag
  ...
  # find source pfd_xdmf
  xDMFReader1 = FindSource('XDMFReader1')
  # set active source
  SetActiveSource(xDMFReader1)  
  # destroy xDMFReader1
  Delete(xDMFReader1)
  del xDMFReader1
